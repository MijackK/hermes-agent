...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Shani' : 'Setting up Shani Agent'

  const description = isUpdate
    ? 'Shani is updating to the latest version — this only takes a moment.'
