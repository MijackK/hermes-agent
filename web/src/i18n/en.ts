...
export const en: Translations = {
  ...
  status: {
    ...
    restartGatewayConfirmMessage:
      'This restarts the Shani gateway process. Connected channels and active sessions will reconnect afterward.',
    ...
    updateHermesConfirmMessage:
      'This runs shani update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.',
    updateHermesConfirmNow: 'Update now',
    updateHermesConfirmTitle: 'Update Shani?',
    updatingHermes: 'Updating Shani…',
  ...
  pluginsPage: {
    ...
    headline: 'Discover, install, enable, and update Shani plugins (`shani plugins` parity).',
  ...
  env: {
    ...
    customHint:
      "Arbitrary environment variables stored in your .env that Shani doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: 'Shani Achievements',
      subtitle:
        'Collectible Shani badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.',
      scan_subtitle: 'Scanning Shani session history. First scan can take 5–10 seconds on large histories.'
    },
    actions: {
      rescan: 'Rescan'
    },
    stats: {
      ...
      latest: 'Latest',
      latest_hint_empty: 'run Shani more',
      none_yet: 'None yet'
    },
    state: {
      unlocked: 'Unlocked',
    ...
    guide: {
      ...
      secret_body:
        'Secrets hide their exact trigger. Once Shani sees a related signal, the card becomes Discovered and shows its requirement.',
      scan_status_header: 'Scan status',
      scan_status_body:
        'Shani is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.',
    ...
    share: {
      ...
      tweet_text: 'Just unlocked {tier_part}"{name}" Shani Agent ☤'
    }
  },
