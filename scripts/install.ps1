    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/MijackK/hermes-agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/MijackK/hermes-agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/MijackK/hermes-agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
...
$InstallStages = @(
    ...
    @{ Name = "repository";       Title = "Cloning Shani repository";            Category = "install";      NeedsUserInput = $false; Worker = "Stage-Repository" }
...
$InstallStages += @(
    @{ Name = "path";             Title = "Adding Shani to PATH";                Category = "finalize";     NeedsUserInput = $false; Worker = "Stage-Path" }
